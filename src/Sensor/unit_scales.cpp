/*
 * @brief A miniscale From M5Stack
 * @copyright Copyright (c) 2022 by M5Stack[https://m5stack.com]
 * MIT License
 * https://github.com/m5stack/M5Unit-Miniscale/
 * https://docs.m5stack.com/ja/arduino/m5gfx/m5gfx_canvas
 */

#include "unit_scales.hpp"

bool UNIT_SCALES::begin(TwoWire *wire, uint8_t addr) {
    _wire = wire;
    _addr = addr;
